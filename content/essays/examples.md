---
unlisted: true
title: You aren't using enough examples
tags: [experts, novices, pedagogy, examples, explainers, needs-writing,
definitions]
---
unlisted: true

<!--
An essay about how you should use more examples in your work when trying
to convey complicated topics.
-->

I'm not sure why, but explanations seem to be immensely easier when you lead
with an example and then go to the abstract, rather than the other way around.
[Grand Sanderson][1] has spoken about this before, and this shows in his
3blue1brown videos.

It seems true that people work this way, but why is there the disconnect
between how we want to explain the topic and how we want to learn the topic?
