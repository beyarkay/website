...
tags: [ai, agi, debate, essays, opinions]
---
unlisted: true
...
Some arguments against AI x-risk:

- AI can't be smart enough
- AI doesn't have goals
- AI won't want to take over us
- we won't let AI take control
- we'll stop AI before it gets too powerful
- AI couldn't take any actions that would result in x-risk
  - x-risk is an inherently difficult thing to cause, there's always going to
    be some people left over hiding somewhere
  - The AI might not want to extinct humanity, we might be useful to it in
    some way.
  - AI might not get rid of all of us, but might keep some of us on for
    entertainment/as pets.
- AI could take over but won't care about killing us or doing anything with the
  things we need.
